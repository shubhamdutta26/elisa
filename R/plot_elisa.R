...
#' data. By default it will use "od450."  If using default names (using create_plate()) this argument may
#' remain NULL.
...
#'
#' empty_plates <- system.file("extdata", "empty_plates.xlsx", package = "elisa")
